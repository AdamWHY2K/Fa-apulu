...
echo.
echo Installing python packages, exit and install python if you don't have it installed.
pip install PyVDF
pip install vdf
...
echo.
echo Starting second phase: "copyHeaders" and "findLatest"
...
echo.
echo Starting final phase: "scheduleUpdate"
(
echo chdir /d %CD%\@Resources\scripts
echo start "" "getUpdate.exe"
)>@Resources\scripts\Fa'apulu_Updater.bat

SchTasks /Create /IT /SC WEEKLY /TN "Fa'apulu Updater" /TR "%CD%\@Resources\scripts\Fa'apulu_Updater.bat"
pause
